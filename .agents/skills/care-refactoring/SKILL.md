...
description: Use when asked to make a codebase easier to understand, safer to change, or more consistent with existing architecture without changing behavior; includes repository discovery, scoped refactor selection, challenge review, minimal implementation, validation, and a "no changes needed" outcome.
---
