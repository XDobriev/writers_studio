...
- **Замысел** — до-письменный слой: один rich-text документ на книгу с оглавлением по заголовкам. Полей и шаблонов нет намеренно: все методики планирования (Save the Cat, три акта, снежинка) — это список заголовков с прозой, и документ вмещает любую из них, а набор полей выражает ровно одну
