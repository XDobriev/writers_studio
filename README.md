...
- **Серии книг** — при создании книги отметить «продолжение серии»: перенос персонажей со связями, локаций с картой, заметок и хронологии из предыдущей книги одним действием. Книги группируются на главной; копии независимы — правки в продолжении не затрагивают оригинал
