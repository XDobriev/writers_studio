...
- **Редактор** — TipTap (rich text): жирный, курсив, заголовки, списки, ссылки, выравнивание. 4 режима: Студия / Левый / Правый / Страница. Автосохранение в Supabase.
- **Структура** — Outline (дерево глав), Corkboard (карточки), Focus (полноэкранный режим), Split (два редактора).
...
- **Карта мира** — локации с координатами.
