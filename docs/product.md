...
|---|---|---|
| Claude Code (Pro) | ~$20 / ~1 840 ₽ | Инструмент разработки, не API в продукте |
| Supabase | Free | Бесплатный тариф, до перехода на self-hosted (§9) при росте нагрузки |
| Сервер (VPS) | 1 200 ₽ | Timeweb, Ubuntu 24.04 |
| Домен | ~125 ₽ | avtorstudio.com |
| **Итого** | **~3 165 ₽/мес** | Рост при переходе Claude Code на Max или Supabase на Pro |

Безубыточность при 399 ₽/мес (с учётом комиссии Robokassa 3,9% и НПД 4%, чистыми ~368 ₽ с подписчика): **~9 платных подписчиков**.

Альтернатива: **1 Lifetime-покупка** (4 990 ₽ ≈ 4 593 ₽ чистыми) закрывает больше месяца расходов.
