...
_Обновлён: 2026-05-31 (закрыты: feat(pov) is_pov/useChapterPovMap/палитра цветов ✅, §28а рефакторинг хуков ✅; ранее 2026-05-30: §13 двухсторонние связи ✅, planRef null-init ✅, debounce removeAlias ✅, fix(snapshots) words=0 ✅, карта мира режимы ✅, §8 онбординг в Supabase ✅, fix(state) гонки ✅; далее: всё закрытое ↓)_
