...
- **Публичная демо-книга / интерактивный preview без регистрации (живой демо-режим)** — крупная фича (sample-контент, read-only режим, риск пути ShareBook.tsx); отложена по решению пользователя 2026-06-30, требует отдельного скоупинга перед реализацией. **Точка входа готова:** вторичная кнопка hero «Посмотреть, как выглядит →» сейчас скроллит к `#features`; при реализации демо-режима — перевести её цель на живую демо-книгу (сильнее снижает порог, чем скролл к секции).
