...
### R7. Серия книг + перенос данных в продолжение

**Что это:** концепция «серии» + перенос персонажей/локаций/карты/заметок/хронологии
из книги 1 в книгу-продолжение (модель копирования, книги остаются независимы).

**Статус:** дизайн-спек готов — `docs/superpowers/specs/2026-07-15-series-continuation-design.md`.
Спек №1 из 3 (Серия → Multi-map → План книги). Следующий шаг — план реализации.
...
**Статус:** Спек №2 из 3. Делать после R7. Перенос (R7) спроектирован расширяемо
под выбор карт.
...
**Статус:** Спек №3 из 3. Делать после R7, R8.
