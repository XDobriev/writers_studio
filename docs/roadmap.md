...
**Deps:** §1 (email-механика), UniSender Go API-ключ в Supabase Vault
...
**Триггер:** минимум 3 пользователя самостоятельно пожалуются на неудачную обрезку обложки. До этого — пользователь может обрезать фото на телефоне. Это решается на уровне контента, не продукта.
