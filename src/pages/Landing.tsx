...
function LandingFAQ() {
  const items = [
    ...
    { q: 'Хранятся ли мои книги в облаке?', a: 'Да, в защищённой облачной базе данных с шифрованием. Доступ только у вас — через email, Telegram или VK ID. Данные хранятся с автоматическим резервным копированием. В любой момент можно скачать полный экспорт рукописи в DOCX, EPUB или FB2.' },
