...
const ENTRIES: Entry[] = [
  {
    date: '15 июля 2026',
    items: [
      'Появился «Замысел» — отдельная страница для плана книги: пишите свободным текстом, а оглавление собирается само из заголовков.',
      'Книги можно объединять в серию: при создании продолжения персонажи, локации с картой, заметки и хронология переносятся одним действием.',
    ],
  },
  {
    date: '30 июня 2026',
