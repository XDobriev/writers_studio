      ...
      <div style={{ maxWidth: 680, margin: '0 auto' }}>
        ...
        <Section title="3. Регистрация и аккаунт">
          <ul>
            ...
            <li>Возраст регистрирующегося — не менее 14 лет.</li>
          </ul>
        </Section>
        ...
        <Section title="5. Тарифы и оплата">
          ...
          <p>
            Сервис находится в открытой бете. В период беты все функции доступны на
            бесплатном тарифе без ограничений.
          </p>
        </Section>
