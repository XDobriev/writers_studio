  ...
  return (
    ...
    >
      ...
      >
        ...
        <div style={{ font: '500 16px var(--font-serif)', letterSpacing: '-0.005em', display: '-webkit-box', WebkitLineClamp: 2, WebkitBoxOrient: 'vertical', overflow: 'hidden', overflowWrap: 'anywhere' }}>{c.title || 'Без названия'}</div>
      </Link>
