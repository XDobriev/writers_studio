...
**Дэшборд книги (`/books/:id`)** — *пока на демо-данных, в проверке не приоритет.*
...
- Навигация в sidebar на Манускрипт/Карта/Хронология.
- Связи и «появляется в главах» — плейсхолдеры, не функциональны.

**Карта / Хронология / Focus / Split / Export / дэшборд книги** — демо, не в проверке.
