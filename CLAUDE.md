...
Дальше:
- **Заход 12+** — writing-snapshots для графиков дэшборда (heatmap активности, серия дней, накопленный объём), графическая карта по координатам, горизонтальная timeline по pos, DOCX/EPUB экспорт через библиотеки.
